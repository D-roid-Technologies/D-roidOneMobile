...
const EventRegistrationForm: React.FC<EventRegistrationFormProps> = ({
  ...
  // Using a ref to track submission state and prevent multiple submissions
  ...
  const stopSpin = () => spinValue.setValue(0);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Parent (EventDescriptionScreen) handles modal close + feedback.
      // Only show alert for events that don't have a dedicated progress screen.
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* new loader for the submit button */}
        {isItloading === true ? (
          <TouchableOpacity
            style={[
              styles.submitButton,
