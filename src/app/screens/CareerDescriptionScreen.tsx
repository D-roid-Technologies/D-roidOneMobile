    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.subInfo}>Location: {position.location}</Text>
          <Text style={styles.subInfo}>Salary: {position.salaryRange}</Text>
          <Text style={styles.subInfo}>
            Posted: {position.postedDate} | Deadline: {position.deadline}
          </Text>
          <Text style={styles.status}>Status: {position.status}</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>+2349165275635</Text>
        </View>
        ...
        {position.status.toLowerCase() === "open" && (
          <TouchableOpacity
            ...
            onPress={() =>
              (navigation as any).navigate("InternshipApplication")
            }
          >
            <Text style={styles.applyButtonText}>Apply Now</Text>
            <Ionicons name="arrow-forward" size={20} color="#000c3a" />
          </TouchableOpacity>
        )}
      </ScrollView>
    </View>
