...
const ProgressionHeader: React.FunctionComponent = () => {
  ...
  const { tier, totalHours, progressPercentage, nextTier, status, desc } =
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={{ flexDirection: "row", gap: 10, alignItems: "center" }}>
            <Text style={styles.subtitleA}>{status}</Text>

            {tier === "Platinum" ? null : (
              <Text style={styles.subtitleA}>-</Text>
            )}
            {tier === "Platinum" ? null : (
              <Text style={styles.subtitleA}>Next Level: {nextTier}</Text>
            )}
          </View>
          ...
          <View style={styles.timeBox}>
            ...
            {tier !== "Silver" && (
              <TouchableOpacity onPress={onDowngradePress}>
                <Text style={styles.downgradeText}>{text}</Text>
              </TouchableOpacity>
            )}
          </View>
        </View>
        ...
        <View style={styles.upgradeSection}>
          ...
          <Text style={styles.upgradeDesc}>
            Unlock exclusive benefits and rewards as you move up to Gold or
            Platinum tiers.
          </Text>
        </View>
        ...
        >
          ...
          <Text style={styles.tierDesc}>
            Unlock every premium feature, VIP support, and elite membership
            benefits.
          </Text>
        </TouchableOpacity>
