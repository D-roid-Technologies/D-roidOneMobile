...
const servicesPosts = [
  {
    ...
    howWeWork:
      "Our team follows agile methodology, working in sprints to deliver iterative progress with clear milestones.",
    howToPay:
      "Payments can be made via bank transfer, PayPal, or other digital payment platforms.",
    extra:
      "We offer post-launch support and maintenance packages to ensure your software runs smoothly.",
  },
  {
    id: 2,
    title: "Tech Training",
    ...
    howWeWork:
      "Our sessions are interactive, combining theory, practical projects, and personalized mentorship.",
    howToPay:
      "Pay per course, subscription packages, or group training options are available.",
  ...
  },
  {
    ...
    howWeWork:
      "We start with a consultation, draft storyboards or strategy plans, and iterate with client feedback.",
    howToPay:
      "Flexible payment options include milestones or full upfront payments depending on project size.",
    extra:
      "We also offer ongoing consultancy for animation and technology strategy to ensure business growth.",
  },
];
