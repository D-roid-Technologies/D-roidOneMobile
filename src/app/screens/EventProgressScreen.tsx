...
const EventProgressScreen: React.FC = () => {
  ...
  const { event, isRegistered, registrationData } = route.params as RouteParams;
          ...
          <>
            ...
            {registrationData && (
              <View style={styles.summaryRow}>
                {isChess && registrationData.chessTier && (
                  <View
                  ...
                  >
                    ...
                    >
                      {registrationData.chessTier === "Elite"
                        ? "♛ Elite"
                        : registrationData.chessTier === "Challenger"
                          ? "♜ Challenger"
                          : "♞ Rising Star"}
                    </Text>
                  </View>
                )}
                {isChess && registrationData.chessPreferredFormat && (
                  <View
                  ...
                  >
                    ...
                    >
                      {registrationData.chessPreferredFormat} Format
                    </Text>
                  </View>
                )}
                {isDevDive && registrationData.fieldOfInterest && (
                  <View
                    style={[styles.summaryPill, { backgroundColor: "#EEF2FF" }]}
                  >
                    <Text
                      style={[styles.summaryPillText, { color: "#3730A3" }]}
                    >
                      {registrationData.fieldOfInterest}
                    </Text>
                  </View>
                )}
                {isDevDive && registrationData.experienceLevel && (
                  <View
