...
const CropToolScreen: React.FC = () => {
    ...
    const pickImage = async () => {
        ...
        const result = await ImagePicker.launchImagePickerAsync({
            ...
            allowsEditing: true,
            aspect: aspectRatio === "1:1" ? [1, 1] : aspectRatio === "4:3" ? [4, 3] : aspectRatio === "16:9" ? [16, 9] : undefined,
            quality: 1,
        });
    ...
    const saveImage = async () => {
        ...
        try {
            ...
            if (permission.granted) {
                ...
                Alert.alert("Permission Required", "Permission to save to gallery is required!");
            }
        } catch (error) {
            ...
            {selectedImage ? (
                <View style={styles.imageContainer}>
                    ...
                    <View style={styles.imageActions}>
                        ...
                        <TouchableOpacity style={styles.imageActionButton} onPress={saveImage}>
