...
const TranslatorScreen: React.FC = () => {
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.languageSection}>
                ...
                <View style={styles.languageContainer}>
                    ...
                    <View style={styles.pickerWrapper}>
                        <Text style={styles.flagIcon}>{getLanguage(sourceLanguage)?.flag}</Text>
                        <Picker
                ...
                <View style={styles.languageContainer}>
                    ...
                    <View style={styles.pickerWrapper}>
                        <Text style={styles.flagIcon}>{getLanguage(targetLanguage)?.flag}</Text>
                        <Picker
            ...
            {/* Translate Button */}
            <TouchableOpacity
                style={[styles.translateButton, !sourceText.trim() && styles.buttonDisabled]}
                onPress={translate}
            ...
            {translatedText && (
                <View style={styles.textSection}>
                    <View style={styles.resultHeader}>
                        ...
                        <TouchableOpacity onPress={copyTranslation} style={styles.copyButton}>
            ...
            <View style={styles.infoCard}>
                <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoText}>
                        This is a demo translator. Connect a translation API (like Google Translate or DeepL) for real translations.
                    </Text>
                </View>
                <View style={styles.infoRow}>
                    <Ionicons name="globe-outline" size={20} color="#10B981" />
                    <Text style={styles.infoText}>
                        Supports 12 major languages including English, Spanish, French, and more.
                    </Text>
                </View>
            </View>
        </ScrollView>
