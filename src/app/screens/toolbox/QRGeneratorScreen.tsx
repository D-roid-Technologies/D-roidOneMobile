        ...
        <View style={styles.qrContainer}>
          <View style={styles.qrWrapper}>
            ...
            <QRCode
              ...
              ecl="H" // High error correction — more robust scanning
            />
          </View>
          ...
          <TouchableOpacity style={styles.shareBtn} onPress={shareQR}>
            ...
            <Text style={styles.shareBtnText}>Share Content</Text>
          </TouchableOpacity>
        </View>
      ) : (
...
//     const generateQR = () => {
//         if (!inputText.trim()) {
//             Alert.alert("Input Required", "Please enter text or URL to generate QR code");
//             return;
//         }
//         setQrText(inputText);
//     };
...
//                             <Ionicons name="qr-code" size={qrSize - 50} color="#000000" />
//                         </View>
//                     </View>
//                     <Text style={styles.qrValue} numberOfLines={2} ellipsizeMode="middle">
//                         {qrText}
...
//                             Demo QR Code - Install react-native-qrcode-svg for real QR generation
//                         </Text>
//                     </View>
//                 </View>
//             ) : (
