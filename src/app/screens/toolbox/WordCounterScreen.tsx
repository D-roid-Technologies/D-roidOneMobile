...
const WordCounterScreen: React.FC = () => {
    ...
    const getStats = () => {
        ...
        return { words, chars, charsNoSpaces, spaces, lines, sentences, paragraphs };
    };
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
            ...
            <View style={styles.statsContainer}>
                <View style={styles.statCard}>
                    <Ionicons name="return-down-forward-outline" size={24} color="#F59E0B" />
            ...
            {stats.words > 0 && (
                <View style={styles.readingTimeCard}>
                    ...
                    <Text style={styles.readingTimeText}>
                        Estimated reading time: <Text style={styles.readingTimeBold}>{estimatedReadTime} min</Text>
                    </Text>
                </View>
            )}
