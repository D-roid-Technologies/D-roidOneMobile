      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <Stack.Screen
            ...
            component={InternshipApplicationScreen}
          />
          ...
          <Stack.Screen
            name="FindSomeoneScreen"
            component={FindSomeoneScreen}
          />
          <Stack.Screen
            name="Explore More Apps"
            component={ExploreMoreAppsScreen}
          />
          <Stack.Screen
            name="CareerDescriptionScreen"
            component={CareerDescriptionScreen}
          />
